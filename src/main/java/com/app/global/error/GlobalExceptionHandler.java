...
public class GlobalExceptionHandler {
    ...
    //javax.validation.Valid 혹은 @Validated binding error가 발생할 경우
    @ExceptionHandler(BindException.class)
    protected ResponseEntity<ErrorResponse> handlerBindException(BindException e) {
    ...
    //지원하지 않은 HTTP method를 호출할 경우 발생
    ...
    protected ResponseEntity<ErrorResponse> handlerConflict(BusinessException e) {
